    ...
    return (
        <div className='pt-[2%] px-[4%] h-[120vh] overflow-y-scroll flex flex-col relative'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-[#BDC3C7] text-[12px]'>You and Your Friend will receive Bonuses</p>
            </div>
            <div className='flex flex-col gap-2'>
                <div data-aos="flip-left" className='px-4 py-1 bg-black text-white border-[#272A2F] border-[1px] flex w-full justify-between items-center rounded-[8px]'>
                    <div className=' flex gap-3 py-2'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <span className='flex flex-row gap-1'>
                                ...
                                <p className='text-[12px] '> <span className='text-[#E6C91B]'>+5,000</span> for you and your friend</p>
                            </span>
                        </div>
                    </div>
                </div>
                <div data-aos="flip-right" className='px-4 py-1 bg-black text-white border-[#272A2F] border-[1px] flex w-full justify-between items-center rounded-[8px]'>
                    <div className=' flex gap-3 py-2'>
                        <img width={45} height={30} src={"/gift (2).svg"} alt='' />
                        <div className='flex flex-col gap-2'>
                            <p className='text-[12px] font-bold'>Invite a friend with Telegram Premium</p>
                            <span className='flex flex-row gap-1'>
                                <img width={25} height={25} src={"/coin1.svg"} alt='' />
                                <p className='text-[12px] '> <span className='text-[#E6C91B]'>+5,000</span> for you and your friend</p>
                            </span>
                    ...
                    <div className='w-full relative flex items-center justify-center bg-[black] z-[5000] rounded-[8px] border-t-[2px]  py-4 border-t-[#1DCD5C]'>
                        ...
                        <div>
                            {user.invited_friends && user.invited_friends.length === 0 ?
                                ...
                                :
                                user.invited_friends && user.invited_friends.map((fr) => <div key={fr} className='text-[#7C7C7C] text-[16px]'>{fr}</div>)
                            }
                        </div>
                    </div>
