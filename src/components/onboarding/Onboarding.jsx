  ...
  const pages = [
    ...
    <div className='bg-black w-full h-[100vh] flex flex-col items-center justify-center text-white' key="page1">
      ...
      <div className='flex w-full px-[7%]'>
        <Link to={"/exchange/" + username} className='bg-gradient-to-r from-[#10a042] text-2xl to-[#00FC87] flex items-center justify-center w-full py-2 rounded-[8px]'>Play</Link>
      </div>
